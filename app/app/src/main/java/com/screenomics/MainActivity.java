                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (uploadService != null) {
                            if (uploadService.status == UploadService.Status.SENDING) {
                                numUploadText.setText("Uploading: " + uploadService.numUploaded + "/" + uploadService.numTotal);
                                Log.i(TAG, "Status:" + UploadService.Status.SENDING.toString());
                                ...
                                Log.i(TAG, "Status:" + UploadService.Status.SUCCESS.toString());
                                ...
                                Log.i(TAG, "Status:" + UploadService.Status.FAILED.toString() + ", CODE: " + uploadService.errorCode);
                            } else {
                                numUploadText.setText(uploadService.status.toString());
                                Log.i(TAG, "Status:" + uploadService.status.toString());
                            }
                        }
                        else
                            Log.i(TAG, "Upload service was null!");
                    }
                });
            }
        }, 500, 5000);
